...
class CPT_Opportunities
{
	private $meta_config_args;
	const POST_TYPE = 'cpt_opportunity';
	...
	public function register_taxonomy()
	{
		...
		register_taxonomy(
			'opportunity_category',    // Name of taxonomoy
...
$CPT_Opportunities = new CPT_Opportunities();